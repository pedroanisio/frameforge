...
def write_scope(out_dir: Path, entries: list[CorpusEntry], files: dict[str, Any], *, dry_run: bool) -> None:
    ...
    lines += [
        ...
        "",
        "- Can FrameGraph ingest EPUB spine/chapter structure and preserve semantic text runs?",
        "- Can FrameGraph ingest PDF page geometry, text blocks, images, tables, formulas, and captions?",
        "- Can imported books be lowered to live FrameGraph pages without raster-only shortcuts?",
        "",
