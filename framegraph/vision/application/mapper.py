"""Default mapper: one :class:`Observation` → one FrameGraph object dict.

Stroke geometry goes through the SDK's :func:`framegraph.sdk.paint.stroke`
...
from framegraph.sdk.paint import stroke as stroke_fields
