"""Value objects for the vision (image/document → FrameGraph) bounded context.
...
CV heuristic or a vision model. It is mapped to a FrameGraph object and then
...
class Observation:
    ...
    Conventions used by :class:`framegraph.vision.application.mapper`:
