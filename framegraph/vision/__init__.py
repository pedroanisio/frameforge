"""Vision context: propose FrameGraph documents from images and documents.

The inverse of the renderer — instead of FrameGraph → pixels, this proposes
FrameGraph objects *from* pixels. Classical OpenCV/numpy detectors and an
