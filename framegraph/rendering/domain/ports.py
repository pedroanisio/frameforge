...
class ScenePainter(Protocol):
    ...
    # ---- primitives ----
    def rect(self, x, y, w, h, fill, stroke, radius=0) -> str: ...
    def ellipse(self, cx, cy, rx, ry, fill, stroke) -> str: ...
    def circle(self, cx, cy, r, fill, stroke) -> str: ...
    def line(self, x1, y1, x2, y2, stroke) -> str: ...
    def poly(self, tag: str, points: str, fill, stroke) -> str: ...
    def path(self, d: str, fill, stroke) -> str: ...
