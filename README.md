...
# validate the delivered tracked fixtures — 38/38 zero errors in docs/FIXTURE-STATUS.md
make validate
...
- The current delivered top-level fixture status is generated in `FIXTURE-STATUS.md`;
  at this snapshot **38/38** have zero errors. Advisory warnings, when present, are
