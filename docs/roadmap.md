...
| Engineering standards | [codebase-standards.md §16](codebase-standards.md) — the `[Target]` ledger | gating ruff, `mypy --strict`, coverage gate, TDD trees, golden drift tolerance, pre-commit (rows 7 `__version__`/release and 8 multi-version CI matrix + `classifiers` closed 2026-07-04) |
