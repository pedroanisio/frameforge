...
[`README.md`](../README.md); the logo assets it governs live in
[`brand/`](../brand/), generated by
[`examples/framegraph_logo.py`](../examples/framegraph_logo.py) (§3).
...
[`examples/framegraph_logo.py`](../examples/framegraph_logo.py) — the same `mark()`
...
```sh
uv run python examples/framegraph_logo.py   # writes brand/framegraph-*.svg + the .fg.yaml
```
...
| File | What |
|---|---|
| [`framegraph-mark.svg`](../brand/framegraph-mark.svg) | the icon — primary, two-tone, transparent |
| [`framegraph-mark-mono.svg`](../brand/framegraph-mark-mono.svg) | one-colour ink |
| [`framegraph-mark-reversed.svg`](../brand/framegraph-mark-reversed.svg) | reversed, on an ink ground |
| [`framegraph-mark-favicon.svg`](../brand/framegraph-mark-favicon.svg) | tight-crop favicon master |
| [`framegraph-wordmark.svg`](../brand/framegraph-wordmark.svg) | the horizontal lockup (mark + wordmark) |
| [`framegraph-logo.fg.yaml`](../brand/framegraph-logo.fg.yaml) | the FrameGraph source document (every variant as a page) |
