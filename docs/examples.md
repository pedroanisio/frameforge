...
The 146 tracked, runnable SDK clients under `static/examples/`, indexed by their stated intent (the module docstring's first line). Run any of them with `uv run python static/examples/<name>.py`; most write their output under `out/` or `_tmp/`.
...
| [`frameforge_whitepaper.py`](../static/examples/frameforge_whitepaper.py) | FrameForge — the company behind FrameGraph: a print-ready A4 white paper. |
