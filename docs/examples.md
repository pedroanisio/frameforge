...
The 77 tracked, runnable SDK clients under `examples/`, indexed by their stated intent (the module docstring's first line). Run any of them with `uv run python examples/<name>.py`; most write their output under `out/` or `_tmp/`.
