...
The Python SDK lives under `frameforge.sdk`. It is a hand-written binding over the repository's authoritative Pydantic model, so document-producing APIs validate through `frameforge.model.Document` instead of redeclaring core schema types.
