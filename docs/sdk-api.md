...
`frameforge_sdk.author.MasterBuilder`
...
`frameforge_sdk.author.PageBuilder`
...
| `card` | `(self, box: 'Any', **fields: 'Any')` | Add a card widget and return its :class:`~frameforge_sdk.Panel`. |
| `chart` | `(self, box: 'Any', *, domain: 'tuple[float, float, float, float]', x_scale: 'Any' = 'linear', y_scale: 'Any' = 'linear')` | Return a :class:`~frameforge_sdk.Chart` mapped to ``box``. |
...
`frameforge_sdk.author.StackBuilder`
...
`frameforge_sdk.canon.caps_tracking`
...
`frameforge_sdk.canon.content_box`
...
`frameforge_sdk.canon.johnston_margins`
...
`frameforge_sdk.canon.measure_fits`
...
`frameforge_sdk.canon.modular_scale`
...
`frameforge_sdk.chevreul.ClosedPalette`
...
`frameforge_sdk.chevreul.closed_palette`
...
`frameforge_sdk.chevreul.complement`
...
`frameforge_sdk.chevreul.complement_name`
...
`frameforge_sdk.chevreul.contrast_of_colours`
...
`frameforge_sdk.chevreul.contrast_of_hues`
...
`frameforge_sdk.chevreul.contrast_of_scale`
...
`frameforge_sdk.chevreul.contrast_ratio`
...
`frameforge_sdk.chevreul.dominant_light`
...
`frameforge_sdk.chevreul.grey_document`
...
`frameforge_sdk.chevreul.color_guide`
...
`frameforge_sdk.chevreul.harmony_of_hues`
...
`frameforge_sdk.chevreul.harmony_of_scale`
...
`frameforge_sdk.chevreul.nearest_station`
...
`frameforge_sdk.chevreul.relative_luminance`
...
`frameforge_sdk.chevreul.to_grey`
...
`frameforge_sdk.chevreul.tone_scale`
...
`frameforge_sdk.clip.clip_circle`
...
`frameforge_sdk.clip.clip_ellipse`
...
`frameforge_sdk.clip.clip_inset`
...
`frameforge_sdk.clip.clip_path`

Clip to an SVG path; ``d`` may be a string or a :class:`frameforge_sdk.Path`.
...
`frameforge_sdk.clip.clip_polygon`
...
`frameforge_sdk.clip.mask_gradient`
...
`frameforge_sdk.clip.mask_style`
...
`frameforge_sdk.clip.normalize_mask`
...
`frameforge_sdk.clip.normalize_clip`
...
`frameforge_sdk.colorspace.delta_e`
...
`frameforge_sdk.colorspace.from_lab`
...
`frameforge_sdk.colorspace.from_lch`
...
`frameforge_sdk.colorspace.from_oklab`
...
`frameforge_sdk.colorspace.from_oklch`
...
`frameforge_sdk.colorspace.from_xyz`
...
`frameforge_sdk.colorspace.linear_to_srgb`
...
`frameforge_sdk.colorspace.ramp`
...
`frameforge_sdk.colorspace.srgb_to_linear`
...
`frameforge_sdk.colorspace.to_lab`
...
`frameforge_sdk.colorspace.to_lch`
...
`frameforge_sdk.colorspace.to_oklab`
...
`frameforge_sdk.colorspace.to_oklch`
...
`frameforge_sdk.colorspace.to_xyz`
...
`frameforge.conform.assert_golden`
...
`frameforge.conform.collision_report`
...
`frameforge.conform.overflow_report`
...
`frameforge.conform.page_hashes`
...
`frameforge.conform.render_html`
...
`frameforge.conform.render_page_svgs`
...
`frameforge.conform.render_pages_with_stats`
...
`frameforge.conform.write_golden`
...
`frameforge_sdk.expand.ExpandOptions`
...
`frameforge_sdk.expand.ExpandedDocument`
...
`frameforge_sdk.fields.ScalarField`
...
`frameforge_sdk.fields.VectorField`
...
`frameforge_sdk.figure.FigureAsset`
...
`frameforge_sdk.figure.FigureContent`
...
`frameforge_sdk.figure.FigurePlacement`
...
`frameforge_sdk.figure.FigureProvenance`
...
`frameforge_sdk.figure.FigureRef`
...
`frameforge_sdk.figure.ImportedFigurePlacement`
...
`frameforge_sdk.figure.load_figure`
...
`frameforge_sdk.figure.merge_figure_defs`
...
`frameforge_sdk.figure.place_figure`
...
`frameforge_sdk.figure.place_imported_figure`
...
`frameforge_sdk.fractal.dragon_curve`
...
`frameforge_sdk.fractal.koch_curve`
...
`frameforge_sdk.fractal.lsystem`
...
`frameforge_sdk.fractal.sierpinski_arrowhead`
...
`frameforge_sdk.geometry.Camera`
...
`frameforge_sdk.geometry.CubicBezier`
...
`frameforge_sdk.geometry.convex_hull_3d`
...
`frameforge_sdk.geometry.line_intersection`
...
`frameforge_sdk.geometry.mirror`
...
`frameforge_sdk.geometry.point_in_polygon`
...
`frameforge_sdk.geometry.polygon_area`
...
`frameforge_sdk.geometry.polyline_length`
...
`frameforge_sdk.geometry.quarter_circle_kappa`
...
`frameforge_sdk.geometry.ray_plane_intersection`
...
`frameforge_sdk.geometry.ray_segment_intersection`
...
`frameforge_sdk.geometry.ray_triangle_intersection`
...
`frameforge_sdk.geometry.line_curve_intersections`
...
`frameforge_sdk.geometry.segment_curve_intersections`
...
`frameforge_sdk.geometry.segment_intersection`
...
`frameforge_sdk.geometry.segment_plane_intersection`
...
`frameforge_sdk.geometry.segment_polygon_intersections`
...
`frameforge_sdk.geometry.surface_curvature`
...
`frameforge_sdk.geometry.window_to_viewport`
...
`frameforge_sdk.io.svg_to_objects`
...
`frameforge_sdk.io.lower_embedded_svg`
...
`frameforge_sdk.lattices.Lattice`
...
`frameforge_sdk.macros.grid_lines`
...
`frameforge_sdk.macros.hatch_fill`
...
`frameforge_sdk.macros.lorem_paragraphs`
...
`frameforge_sdk.macros.paragraph`
...
`frameforge_sdk.macros.sparkline`
...
`frameforge_sdk.manifold.bezier_patch`
...
`frameforge_sdk.manifold.bezier_patch_point`
...
`frameforge_sdk.manifold.bspline_patch`
...
`frameforge_sdk.manifold.bspline_patch_point`
...
`frameforge_sdk.manifold.klein_bottle`
...
`frameforge_sdk.manifold.mobius`
...
`frameforge_sdk.manifold.parametric`
...
`frameforge_sdk.manifold.saddle`
...
`frameforge_sdk.manifold.sphere`
...
`frameforge_sdk.markdown.from_markdown`
...
`frameforge_sdk.metrics.font_kern_pairs`
...
`frameforge_sdk.metrics.kerned_spans`
...
`frameforge_sdk.metrics.measure_text`
...
`frameforge_sdk.metrics.text_height`
...
`frameforge_api.model.document.Document`

Closed base: unknown keys are errors (the closed-model decision).

```python
Document(*, dsl: Literal['FrameForge'], version: Annotated[str, _PydanticGeneralMetadata(pattern='^\\d+\\.\\d+\\.\\d+(?:-[0-9A-Za-z.-]+)?(?:\\+[0-9A-Za-z.-]+)?$')], profile: Optional[Literal['deck', 'book', 'letter', 'report', 'diagram', 'mixed']] = None, title: Optional[str] = None, description: Optional[str] = None, lang: Optional[str] = None, defs: Optional[frameforge_api.model.document.Defs] = None, targets: Optional[list[frameforge_api.model.document.RenderTarget]] = None, pages: Annotated[list[Annotated[Union[frameforge_api.model.page.Page, frameforge_api.model.page.FlowSection], FieldInfo(annotation=NoneType, required=True, discriminator='mode')]], MinLen(min_length=1)], meta: Optional[dict] = None, humanize: Optional[frameforge_api.model.humanize.Humanize] = None, text_contract: Optional[frameforge_api.model.page.TextContract] = None) -> None
```
...
`frameforge_sdk.model.model_module`
...
`frameforge_sdk.model.to_plain_dict`
...
`frameforge_sdk.model.validate_document`
...
`frameforge_sdk.noise.Noise`

Bind a stable seed, frequency, and primitive basis for clean authoring.

```python
Noise(seed: 'Any' = 0, *, frequency: 'float' = 0.01, basis: 'str' = 'perlin') -> 'None'
```

| Method | Signature | Summary |
|---|---|---|
| `at` | `(self, x: 'float', y: 'float') -> 'float'` | Sample the bound primitive at frequency-scaled coordinates. |
| `derive` | `(self, *parts: 'Any') -> 'Noise'` | Return an order-stable named noise source independent of sibling use. |
| `fbm_at` | `(self, x: 'float', y: 'float', *, octaves: 'int' = 4) -> 'float'` | Sample normalised fBm using the bound seed, frequency, and basis. |
| `field` | `(self) -> 'Callable[[float, float], float]'` | Return a callable ready for :class:`frameforge_sdk.fields.ScalarField`. |

### `domain_warp`

`frameforge_sdk.noise.domain_warp`

Return coordinates warped by two independent samples of ``basis``.

```python
domain_warp(x: 'float', y: 'float', *, seed: 'int' = 0, strength: 'float' = 1.0, basis: 'NoiseBasis' = fbm) -> 'tuple[float, float]'
```

### `fbm`

`frameforge_sdk.noise.fbm`

Return normalised fractional Brownian motion over ``basis`` in O(octaves).

```python
fbm(x: 'float', y: 'float', *, seed: 'int' = 0, octaves: 'int' = 4, lacunarity: 'float' = 2.0, gain: 'float' = 0.5, basis: 'NoiseBasis' = perlin_2d) -> 'float'
```

### `perlin_2d`

`frameforge_sdk.noise.perlin_2d`

Return classic improved Perlin gradient noise in ``[-1, 1]``.

```python
perlin_2d(x: 'float', y: 'float', *, seed: 'int' = 0) -> 'float'
```

### `remap`

`frameforge_sdk.noise.remap`

Map a gradient-noise value from ``[-1, 1]`` into ``[lo, hi]``.

```python
remap(value: 'float', lo: 'float', hi: 'float') -> 'float'
```

### `simplex_2d`

`frameforge_sdk.noise.simplex_2d`

Return Gustavson-style 2D simplex gradient noise in ``[-1, 1]``.

```python
simplex_2d(x: 'float', y: 'float', *, seed: 'int' = 0) -> 'float'
```

### `to_unit`

`frameforge_sdk.noise.to_unit`

Map gradient-noise ``[-1, 1]`` to ``[0, 1]`` without clamping.

```python
to_unit(value: 'float') -> 'float'
```

### `value_noise_2d`

`frameforge_sdk.noise.value_noise_2d`

Return smooth deterministic value noise in ``[0, 1]``.

```python
value_noise_2d(x: 'float', y: 'float', *, seed: 'int' = 0) -> 'float'
```
...
`frameforge_sdk.paint.appearance`
...
`frameforge_sdk.paint.blur_filter`
...
`frameforge_sdk.paint.conic_gradient`
...
`frameforge_sdk.paint.diffuse_lighting`
...
`frameforge_sdk.paint.displacement_map`
...
`frameforge_sdk.paint.effect_stack`
...
`frameforge_sdk.paint.fill_stroke`
...
`frameforge_sdk.paint.filter_chain`
...
`frameforge_sdk.paint.filter_fn`
...
`frameforge_sdk.paint.grid_pattern`
...
`frameforge_sdk.paint.linear_gradient`
...
`frameforge_sdk.paint.radial_gradient`
...
`frameforge_sdk.paint.soft_shadow`
...
`frameforge_sdk.paint.style_effects`
...
`frameforge_sdk.paint.specular_lighting`
...
`frameforge_sdk.paint.text_style`
...
`frameforge_sdk.paint.turbulence`
...
`frameforge_sdk.rand.jittered_grid`
...
`frameforge_sdk.rand.poisson_disk`
...
`frameforge_sdk.region.extract_objects`
...
`frameforge_sdk.region.gradient_map`
...
`frameforge_sdk.region.object_bbox`
...
`frameforge_sdk.region.place_region`
...
`frameforge_sdk.region.region_grade`
...
`frameforge_sdk.region.select_in`
...
`frameforge_sdk.validate.EngineUnavailable`

The engine-side static-rule validator could not be located.

### `Issue`

`frameforge_sdk.validate.Issue`
...
`frameforge_sdk.validate.StaticValidationError`
...
`frameforge_sdk.validate.ValidationReport`
...
`frameforge_sdk.widgets.default_theme`
...
`frameforge_sdk.widgets.register_theme`
...
`frameforge_sdk.widgets.badge_width`
...
`frameforge_sdk.widgets.breadcrumb`
...
`frameforge_sdk.widgets.checkbox`
...
`frameforge_sdk.widgets.dropdown`
...
`frameforge_sdk.widgets.image_placeholder`
...
`frameforge_sdk.widgets.sticky_note`
...
`frameforge_sdk.widgets.progress`
...
`frameforge_sdk.widgets.divider`
