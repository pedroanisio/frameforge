...
`frameforge.sdk.conform.render_html`
...
| `field` | `(self) -> 'Callable[[float, float], float]'` | Return a callable ready for :class:`frameforge.sdk.fields.ScalarField`. |

### `domain_warp`

`frameforge.sdk.noise.domain_warp`
...
`frameforge.sdk.noise.perlin_2d`
...
`frameforge.sdk.noise.simplex_2d`
...
`frameforge.sdk.noise.value_noise_2d`
