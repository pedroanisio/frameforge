...
| **Input** | What does it start from? | "from `ref/logo.png`", "edit `static/examples/deck.py`", "no input" |
...
- "Add a KPI row to `static/examples/dashboard.py` and re-render." → `write_sdk_client` +
  `run_sdk_client`.
