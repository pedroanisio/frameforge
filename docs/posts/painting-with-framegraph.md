...
disclaimer:
  ...
  date: "2026-07-04"
title: "Painting with FrameGraph"
subtitle: "178 trials to a vector reconstruction"
---

# Painting with FrameGraph

*A reading of `framegraph-reconstruction-evolution-4k60.mp4` — sixty seconds,
...
screenshot — 714×456 pixels of FrameGraph primitives — is rebuilt, from
...
FrameGraph object that a validator can inspect and a renderer can re-emit at
...
— the same question `detect_regions` answers in the FrameGraph MCP workspace —
...
it claims to reproduce. FrameGraph's reconstruction loop is not "trace it and
...
Painting with FrameGraph is not drawing. It is a sequence of commitments,
...
*Source: `framegraph-reconstruction-evolution-4k60.mp4` and its run report,
