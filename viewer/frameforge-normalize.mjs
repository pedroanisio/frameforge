...
function normalizeLegacyDeck(doc) {
  ...
  return {
    ...
    version: "2.2.0",
    profile: "deck",
    title: doc.title || deck.title || "FrameForge presentation deck",
...
export function normalizeFrameForgeDoc(doc) {
  if (!doc || typeof doc !== "object") return doc;
  if (Array.isArray(doc.pages)) return normalizeSymbolUses(doc);
  if (doc.dsl === "FrameForge" && doc.kind === "presentation-deck" && Array.isArray(doc.slides)) {
