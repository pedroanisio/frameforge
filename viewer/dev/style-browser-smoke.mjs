    ...
    tokens: {
      ...
      styles: {
        fx: {
          ...
          filter: [
            ...
            { fn: "hue_rotate", value: 30 },
          ],
          transform: [{ fn: "translate_x", args: [4] }, { fn: "rotate", args: [2] }, { fn: "skew_y", args: [3] }],
          mix_blend_mode: "multiply",
          isolation: "isolate",
          clip_path: { shape: "inset", args: { top: 2, right: 4, bottom: 6, left: 8 } },
          opacity: 0.75,
          padding: [4, 6, 8, 10],
          margin: [1, 2, 3, 4],
          min_width: 120,
      ...
      text_styles: {
        display: {
          ...
          text_decoration: { line: "underline", style: "wavy", color: "hairline", thickness: 2 },
          text_indent: "5px",
...
const styles = await page.evaluate(() => {
  ...
  return {
    ...
    rectBgClip: rect.backgroundClip,
    rectBgOrigin: rect.backgroundOrigin,
    rectBgBlend: rect.backgroundBlendMode,
    rectMarginLeft: rect.marginLeft,
    rectMinWidth: rect.minWidth,
    rectMaxWidth: rect.maxWidth,
    rectMinHeight: rect.minHeight,
    rectMaxHeight: rect.maxHeight,
    rectBoxSizing: rect.boxSizing,
    ...
    textDecorationStyle: textInner.textDecorationStyle,
    textDecorationColor: textInner.textDecorationColor,
    textDecorationThickness: textInner.textDecorationThickness,
    ...
    aliasJustify: aliasWrap.justifyContent,
    aliasFontFamily: aliasInner.fontFamily,
    aliasFontStyle: aliasInner.fontStyle,
    aliasFontStretch: aliasInner.fontStretch,
    aliasLineHeight: aliasInner.lineHeight,
    aliasTextWrap: aliasInner.textWrap,
    aliasLineClamp: aliasInner.webkitLineClamp,
...
const checks = [
  ...
  ["rect filter", styles.rectFilter.includes("drop-shadow")],
  ["rect transform", styles.rectTransform !== "none"],
  ["rect mix_blend_mode", styles.rectBlend === "multiply"],
  ["rect isolation", styles.rectIsolation === "isolate"],
  ["rect clip_path args", styles.rectClipPath === "inset(2px 4px 6px 8px)"],
  ...
  ["rect background_clip", styles.rectBgClip === "content-box"],
  ["rect background_origin", styles.rectBgOrigin === "padding-box"],
  ["rect background_blend_mode", styles.rectBgBlend === "multiply"],
  ["rect margin", styles.rectMarginLeft === "4px"],
  ["rect min_width", styles.rectMinWidth === "120px"],
  ["rect max_width", styles.rectMaxWidth === "260px"],
  ["rect min_height", styles.rectMinHeight === "40px"],
  ["rect max_height", styles.rectMaxHeight === "140px"],
  ["rect box_sizing", styles.rectBoxSizing === "border-box"],
  ...
  ["text text_decoration style", styles.textDecorationStyle === "wavy"],
  ["text text_decoration color", styles.textDecorationColor === "rgb(18, 52, 86)"],
  ["text text_decoration thickness", styles.textDecorationThickness === "2px"],
  ...
  ["alias vertical_align", styles.aliasJustify === "flex-end"],
  ["alias font_family", /serif/i.test(styles.aliasFontFamily)],
  ["alias font_style", styles.aliasFontStyle === "italic"],
  ["alias font_stretch", styles.aliasFontStretch === "condensed" || styles.aliasFontStretch === "75%"],
  ["alias line_height", styles.aliasLineHeight === "30px"],
  ["alias text_wrap", styles.aliasTextWrap === "balance"],
  ["alias line_clamp", styles.aliasLineClamp === "1"],
