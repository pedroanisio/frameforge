...
FACTS = {
    "version":      ("2.8.0", "pyproject.toml [project] version"),
    "tests":        (2958,    "uv run pytest --collect-only -q"),
    "tests_pass":   (2958,    "uv run pytest  -> '2958 passed' (0 failed)"),
    "tests_skip":   (0,       "same run: no optional dependency skips"),
    "golden_pages": (88,      "uv run python tooling/render_golden.py"),
    "fixtures":     ("53/53", "docs/FIXTURE-STATUS.md (tooling/gen_status.py)"),
    "capabilities": (477,     "docs/capability-manifest.json .capabilities"),
    "schema_defs":  (105,     "docs/schema/frameforge-v2.schema.json .$defs"),
    "examples":     (158,     "docs/examples.md (tooling/gen_examples_index.py)"),
    "mcp_tools":    (32,      "docs/capability-manifest.json .mcp.tools"),
    "sdk_exports":  (331,     "docs/capability-manifest.json .sdk.public_exports"),
    "object_types": (34,      "docs/capability-manifest.json .model.object_types"),
