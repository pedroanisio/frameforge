...
from frameforge.sdk import Chart, DocumentBuilder, Frame, grid, inset, row, serialize, theme  # noqa: E402
...
def main() -> int:
    ...
    out = os.path.join(ROOT, "static", "examples", "sdk-toolkit.fg.yaml")
