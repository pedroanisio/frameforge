...
from frameforge_sdk import DocumentBuilder, rgba, serialize  # noqa: E402
from frameforge_sdk.layout import column, row  # noqa: E402
...
def main() -> int:
    ...
    out = os.path.join(ROOT, "tests", "fixtures", "atlantis-adventure-game.fg.yaml")
