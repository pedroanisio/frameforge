"""framegraph.library — themes, symbol packs, generators (issue #32).
...
document schema.
"""
from framegraph.library.generators import (
    EXAMPLES_DIR,
    HONEYCOMB_GEOMETRY,
    HONEYCOMB_PALETTE,
    MODULE_GEOMETRY,
...
from framegraph.library.symbols import (
    SYMBOLS_DIR,
    list_symbols,
    load_symbols,
    support_text_styles,
)
from framegraph.library.themes import THEMES_DIR, list_themes, load_theme
