...
from framegraph.rendering.domain.ports import DocumentRenderer
from framegraph.rendering.infrastructure.backends.html import HtmlDocumentRenderer
from framegraph.rendering.infrastructure.backends.pdf_tex import PdfTexDocumentRenderer
