"""A small UI-widget vocabulary that lowers to FrameGraph primitives.
...
:mod:`framegraph.sdk.chart`: pure functions that emit plain object ``dict`` s for
:meth:`framegraph.sdk.PageBuilder.add` / ``extend``.
...
class Theme:
    ...
    work without any :class:`~framegraph.sdk.DocumentBuilder` setup.
    """
