...
:meth:`~framegraph.sdk.DocumentBuilder.section` (the context-manager entry,
symmetric to :meth:`~framegraph.sdk.DocumentBuilder.page`) or standalone via
:meth:`story` + :meth:`~framegraph.sdk.DocumentBuilder.flow`.

Inline Markdown (``**bold**``, ``*italic*``, `` `code` ``, ``$math$``, links and
``{ref:…}`` cross-references) is lowered through :func:`framegraph.sdk.macros.md`
...
from framegraph.sdk.author import Handle, _coerce_handles, _handle_name
from framegraph.sdk.macros import md
...
class FlowBuilder:
    ...
    def para(self, content: Any, **fields: Any) -> "FlowBuilder":
        ...
        lowered to spans via :func:`~framegraph.sdk.macros.md`) or a prepared
        inline list (strings, :func:`~framegraph.sdk.macros.span` dicts, …)."""
