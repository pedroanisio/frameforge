...
topology :class:`~framegraph.sdk.Graph` — flat for 2D, or projected through a
perspective :class:`~framegraph.sdk.Camera` for 3D. Everything is deterministic.
"""
...
from framegraph.sdk.geometry import Camera, Mat4, Vec3
