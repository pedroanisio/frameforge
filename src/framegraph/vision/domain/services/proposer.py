...
FrameGraph envelope is assembled with the SDK's own authoring API
(:class:`framegraph.sdk.author.DocumentBuilder`) rather than a hand-rolled dict,
...
class Proposer:
    """Run available detectors over an image and build a draft FrameGraph document."""
