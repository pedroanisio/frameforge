...
assembled into a layer-plan-ordered FrameGraph document.
...
Boundary: imports only ``framegraph.sdk`` + intra-package (no ``tooling``).
"""
...
from framegraph.coach.clean import clean
from framegraph.coach.ingest import gradientize, recolor_to_style
from framegraph.coach.paint import atmosphere, lightest
from framegraph.coach.redraw import redraw
from framegraph.coach.style import StyleProfile, cleanup_params, redraw_params, resolve_style
...
def compose_objects(
    ...
    *,
    ...
    """Assemble traced region/outline objects into a styled FrameGraph document.
...
def compose_from_image(
    ...
    *,
    ...
    """
    from framegraph.coach.ingest import ingest
