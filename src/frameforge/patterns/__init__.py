"""frameforge.patterns — the declarative slide-template catalog (issue #28).
...
"""
from frameforge.patterns.catalog import (
    Anchor,
    CATALOG_PATH,
    Catalog,
    EnterpriseLayout,
...
from frameforge.patterns.compose import CANVAS_H, CANVAS_W, DEFAULT_TOKENS, compose
from frameforge.patterns.fill import (
    FILLS_DIR,
    PatternFillSidecar,
    SidecarFieldSpec,
    SidecarZoneOverride,
