"""document — transpile a FrameForge flow document to a compilable LaTeX string.
...
face (fontspec) carries the body — "LaTeX-quality rendering OF the FrameForge design".
"""
