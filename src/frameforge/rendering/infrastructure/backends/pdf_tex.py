...
Transpiles a FrameForge document to native LaTeX (TeX owns pagination,
...
class PdfTexDocumentRenderer:
    """Compile a FrameForge document to a typeset PDF via LaTeX/TikZ.
    ...
    def render(self, document, *, base_dir=None, options=None) -> RenderedArtifact:
        from frameforge.rendering.infrastructure.latex.compile import compile_document
