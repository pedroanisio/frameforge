...
from frameforge.mcp.results import _render_failure, _resource_links, _validation_payload
from frameforge.mcp.util import _page_svg_name, _sha256_text
...
def _validate_and_render_yaml(
    ...
    *,
    ...
    if silhouette:
        from frameforge.coach import stage_rubric
