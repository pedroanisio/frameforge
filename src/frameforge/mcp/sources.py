...
:mod:`frameforge.mcp.usecases` drives any of them. Adding a new way to obtain a
...
from frameforge.mcp.discovery import _frameforge_yaml_snapshot, _new_generated_yaml
from frameforge.mcp.execution import (
    _apply_build_error,
    _harness_source,
    _subprocess_env,
    _subprocess_timeout_result,
)
from frameforge.mcp.paths import _repo_root, _session_root, get_default_repo_root
from frameforge.mcp.results import _base_result
from frameforge.mcp.security import (
    _display_path,
