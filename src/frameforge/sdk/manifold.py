...
Each builder returns a :class:`~frameforge.sdk.Scene3D` whose ``parametric_surface``
mesh is ready to ``.render(box=..., camera=...)`` through a perspective
:class:`~frameforge.sdk.Camera`. Includes the classic embedded surfaces (sphere,
...
from frameforge.sdk.geometry import Vec3, _v3
