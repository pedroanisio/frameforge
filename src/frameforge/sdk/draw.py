"""Drawing helpers that solve geometry before emitting FrameForge objects."""
...
from frameforge.sdk.geometry import Camera, Mat4, Path, Vec2, Vec3, window_to_viewport
...
class Material:
    ...
    The helper only expands to ordinary FrameForge object fields. Translucency,
...
def parametric_curve(
    ...
    **fields: object,
    ...
    """Sample a parametric curve ``fn(t) -> (x, y)`` adaptively and emit a FrameForge
...
def _is_back_face(pts: Sequence[Vec2]) -> bool:
    ...
    clockwise — signed shoelace area < 0 in FrameForge's Y-down page space — faces
