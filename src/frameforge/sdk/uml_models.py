"""UML 2.5 ontology — Pydantic v2 models for the FrameForge UML composer.

This module is the typed vocabulary the UML composer (Phase A and
later) consumes. Authors declare their UML model in the FrameForge
...
- This file does NOT register with the FrameForge schema's
...
class UMLClassDiagramModel(BaseModel):
    ...
    Mirrors the FrameForge `semantic` block but with typed UML
