"""Expansion helpers for deterministic FrameForge documents."""
...
def expand(model: Any, opts: ExpandOptions | None = None) -> ExpandedDocument:
    ...
    Geometry helpers already emit concrete 2D FrameForge primitives before
...
def _expand_graph(obj: dict[str, Any]) -> dict[str, Any]:
    ...
    Builds a :class:`~frameforge.sdk.topology.Graph` from the object's
