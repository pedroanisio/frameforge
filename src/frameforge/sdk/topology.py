...
deterministic algorithm, and render it into a single FrameForge group.

The module pairs with :mod:`frameforge.sdk.geometry`'s perspective
:class:`~frameforge.sdk.Camera`: a layout can return 2D positions for a flat
...
from frameforge.sdk.geometry import Camera, Mat4, Vec2, Vec3
...
class Graph:
    ...
    def to_object(self, *, box: Sequence[float], algorithm: str = "auto",
        ...
        auto-layout form that :func:`frameforge.sdk.expand` lowers into a
    ...
    def render(
        ...
        *,
        ...
        """Render the graph to one FrameForge ``group`` fitted into ``box``.
        ...
        group box (origin baked out), matching :class:`~frameforge.sdk.Scene3D`.
