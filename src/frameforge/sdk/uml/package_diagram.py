...
Reads a `UMLPackageDiagramModel` (from frameforge.sdk.uml_models) and produces
a fully-laid-out FrameForge `visual` block. Uses the Sugiyama
hierarchical layout from `frameforge.layout` on the package-
...
from frameforge.sdk.uml_models import UMLPackage, UMLPackageDiagramModel
from frameforge.sdk.uml._composer_base import (
    ComposedDiagram,
