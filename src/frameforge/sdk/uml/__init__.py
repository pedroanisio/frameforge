"""frameforge.uml — UML 2.5 composers.

Each composer reads a typed UML model from `frameforge._uml` and
...
from frameforge.sdk.uml._composer_base import ComposedDiagram, HierarchicalComposer
from frameforge.sdk.uml.activity_diagram import (
    ActivityDiagramOptions,
    compose_activity_diagram,
)
from frameforge.sdk.uml.class_diagram import (
    ClassDiagramOptions,
    compose_class_diagram,
)
from frameforge.sdk.uml.communication_diagram import (
    CommunicationDiagramOptions,
    compose_communication_diagram,
)
from frameforge.sdk.uml.component_diagram import (
    ComponentDiagramOptions,
    compose_component_diagram,
)
from frameforge.sdk.uml.composite_structure import (
    CompositeStructureOptions,
    compose_composite_structure,
)
from frameforge.sdk.uml.deployment_diagram import (
    DeploymentDiagramOptions,
    compose_deployment_diagram,
)
from frameforge.sdk.uml.interaction_overview import (
    InteractionOverviewOptions,
    compose_interaction_overview,
)
from frameforge.sdk.uml.object_diagram import (
    ObjectDiagramOptions,
    compose_object_diagram,
)
from frameforge.sdk.uml.package_diagram import (
    PackageDiagramOptions,
    compose_package_diagram,
)
from frameforge.sdk.uml.profile_diagram import (
    ProfileDiagramOptions,
    compose_profile_diagram,
)
from frameforge.sdk.uml.sequence_diagram import (
    SequenceDiagramOptions,
    compose_sequence_diagram,
)
from frameforge.sdk.uml.state_machine import (
    StateMachineOptions,
    compose_state_machine,
)
from frameforge.sdk.uml.timing_diagram import (
    TimingDiagramOptions,
    compose_timing_diagram,
)
from frameforge.sdk.uml.use_case_diagram import (
