...
Reads a `UMLDeploymentDiagramModel` (from frameforge.sdk.uml_models) and
produces a fully-laid-out FrameForge `visual` block. Uses the
Sugiyama hierarchical layout from `frameforge.layout` on the
