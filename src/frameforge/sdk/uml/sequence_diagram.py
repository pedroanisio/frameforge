...
Reads a `UMLSequenceDiagramModel` (from frameforge.sdk.uml_models) and produces
a fully-laid-out FrameForge `visual` block.
...
from frameforge.sdk.uml._composer_base import ComposedDiagram, str_width
