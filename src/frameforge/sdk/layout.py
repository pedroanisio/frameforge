"""Box-geometry layout helpers for the FrameForge SDK.
...
primitive and with the charting helpers in :mod:`frameforge.sdk.chart`.

There are two complementary ways to lay out a group in FrameForge:
