...
from frameforge_render.domain.services.stroke_resolver import Markers, Stroke  # noqa: E402
...
def test_gradient_handle_is_value_object():
    from frameforge_render.domain.services.paint_resolver import GradientPaint
    p = _grad_painter()
...
def test_tikz_painter_covers_full_scenepainter_surface():
    ...
    from frameforge_render.domain.ports import ScenePainter
