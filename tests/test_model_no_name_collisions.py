...
`docs/models/framegraph.py` once defined ``Image = Union[Gradient, UrlImage, str]``
...
MODEL = os.path.join(ROOT, "docs", "models", "framegraph.py")
...
def test_no_module_level_class_shadows_a_type_alias():
    ...
    assert collisions == set(), (
        ...
        f"assignment in docs/models/framegraph.py: {sorted(collisions)}. A model "
