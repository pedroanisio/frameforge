...
def test_regions_star_exports_match_the_infrastructure_boundary() -> None:
    regions = importlib.import_module("frameforge.vision.infrastructure.regions")
    infrastructure = importlib.import_module("frameforge.vision.infrastructure")
    ...
    exec("from frameforge.vision.infrastructure.regions import *", namespace)
